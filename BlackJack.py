...
def compare(player_score, dealer_score):
    if player_score == dealer_score:
        ...
        return "Dealer ma BLACKJACK. Przegrywasz."
    elif player_score == 0:
        return "Masz BLACKJACK! Wygrywasz!"
    elif player_score > 21:
        return "Przekroczyłeś 21 — przegrywasz."
    elif dealer_score > 21:
        return "Dealer przekroczył 21 — wygrywasz!"
    elif player_score > dealer_score:
        return "Masz więcej punktów — wygrywasz!"
    else:
        return "Dealer ma więcej punktów — przegrywasz."
def game():
    dealer_cards = []
    player1_cards = []
    dealer_score = -1
